<template>
    <div class="m-index" @touchstart="handleTouchstart" @touchend="handleTouchend">
                ...
                <div class="u-content">
                    ...
                    <transition name="fade">
                        ...
                        <div v-if="!showOptions && currentDetail && currentDetail.value < 4" class="u-detail">
                            <div
                                :style="{ backgroundImage: `url(${imgurl}1/${currentDetail.det})` }"
                                class="u-detail-box"
                            >
                                <img
                                    v-show="currentDetail.value === 2"
                                    :src="imgurl + '1/check.png'"
                                    class="u-check-img"
                    ...
                    <transition name="fade">
                        <div v-if="!showOptions && currentDetail && currentDetail.value === 4" class="u-detail">
                            <div
                                :style="{ backgroundImage: `url(${imgurl}1/yongningwan/${currentDetail.active}.jpg)` }"
                                class="u-detail-box"
                            >
                                ...
                                <div class="u-for-img">
                                    <div
                                        v-for="(item, index) in currentDetail.options"
                                        :key="index"
                                        class="u-for-img-box"
                                        :class="{ active: currentDetail.active === item }"
                                        @click="handleThumbEnter(item, index)"
                                    >
                                        <img
                                            :src="imgurl + '1/yongningwan/slider/' + item + '.jpg'"
                                            class="u-for-img-item"
                                        />
                                    </div>
                                </div>
                            </div>
        ...
        <!--区域四内容-->
        <transition name="fade">
            <div class="m-block m-four" :style="{ backgroundImage: `url(${imgurl}3/${fourActive}.jpg)` }">
                <div class="u-content">
                    <!--                    底部区域图标及切换区域-->
                    <!--                        百强图片链接-->
        ...
        <!--区域五内容-->
        <transition name="fade">
            <div class="m-block m-five">
                <!--                容器分左右，中间竖向线条间隔-->
                <div class="u-content">
                    <div class="u-left">
                        <img
                            :src="imgurl + '4/tab/1.png'"
                    ...
                    <div class="u-right">
                        <div ref="pageContainer" class="u-right-box">
                            <img
                                :key="`${selectedTab}_${currentPage}`"
                                :src="`${imgurl}4/${selectedTab}_${currentPage}.png`"
                                class="u-right-img"
                            />
                        </div>
...
export default {
    ...
    methods: {
        ...
        jdtClick(tabIndex) {
            ...
            let arr = ["12372", "12373", "12374", "12375", "12376"];
