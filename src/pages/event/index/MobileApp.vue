            ...
            <div class="event-scroll-wrapper" ref="scrollWrapper">
                <div class="event-list" ref="eventList" v-if="currentMonthEvents">
                    <div class="event-month">
                        <span> {{ currentMonthEvents.month }}月 </span>
                    </div>
                    <div
                        class="event-item"
                        v-for="(listItem, index) in currentMonthEvents.list"
                        :key="index"
...
export default {
    ...
    methods: {
        load() {
            ...
            this.currentMonthEvents = this.monthList.find((m) => m.month == currentMonth) || null;
